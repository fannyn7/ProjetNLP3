...
public class Recipe {
	...
	public List<Ingredient> mayContainIngredient(String ingredient_description) {
		List<Ingredient> candidates = new ArrayList<Ingredient>();
		// TODO : improve the performance using WordNet
		for (Ingredient i : getIngredients()) {
			if (ingredient_description.contains(i.getName())) {
				Ingredient ingFound = new Ingredient();
				ingFound.setName(i.getName());
				ingFound.setQuantity(i.getQuantity());
				candidates.add(ingFound);
			}
		}
	...
	// TODO Uncomment following lines to take the instructions in account
	/*
	 * public List<Directive> getInstructions() { if (this.instructions == null)
	 * { this.instructions = new ArrayList<Directive>(); } return instructions;
	 * }
	 * 
	 ...
	 * Directive d = new Directive(); d.setInstruction(a.getNormalizedName());
	 * d.setIngredient(a.getIngredient());
	 * d.setResultingEntity(a.getResultingEntity()); return d; }
	 */
